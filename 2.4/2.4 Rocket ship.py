...
def rocketShip(planetColor, isEngineOn, isOnPlanet):
    ...
    ### Fix Your Code Here ###
    engineFire = Polygon(190, 335, 180, 360, 190, 355, 200, 370, 210, 355, 220, 360, 210,
            335, fill=gradient('yellow', 'orange', 'red', start='top'))
            
    engineFire.visible = isEngineOn
    ...
    ### Fix Your Code Here ###
    planet = Circle(200, 1000, 650, fill=planetColor)
    planet.visible = isOnPlanet
