...
def onKeyPress(key):
    ...
    if (key == 'up' and not app.wheelbarrowLifted):
        liftWheelbarrow()
        app.wheelbarrowLifted = True
    elif (key == 'down' and app.wheelbarrowLifted):
        placeWheelbarrow()
        app.wheelbarrowLifted = False
    ...
    ### Place Your Code Here ###
    if (key == 'right' and app.wheelbarrowLifted):
        moveWheelbarrow(35)
