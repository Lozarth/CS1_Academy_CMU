...
def drawWinner(leftMove, rightMove):
    ...
    if (leftMove == 'Paper' and rightMove == 'Rock'):
        Label('>', 200, 200, size = 60)
    elif (leftMove == 'Rock' and rightMove == 'Paper'):
        Label('<', 200, 200, size = 60)
    
    if (leftMove == 'Rock' and rightMove == 'Scissors'):
        Label('>', 200, 200, size = 60)
    elif (leftMove == 'Scissors' and rightMove == 'Rock'):
        Label('<', 200, 200, size = 60)
        
    if (leftMove == 'Scissors' and rightMove == 'Paper'):
        Label('>', 200, 200, size = 60)
    elif (leftMove == 'Paper' and rightMove == 'Scissors'):
        Label('<', 200, 200, size = 60)
    pass
